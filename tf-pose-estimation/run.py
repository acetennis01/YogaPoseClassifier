...
def process(imgPath, e):
    for imgDir in os.listdir(imgPath):
        for img in os.listdir(imgPath + imgDir + "/"):
            ...
            drawPath = "/home/abhiram/Documents/poseDetection/preProcessDrawImage/" + imgDir + "/" + img[0:8] + ".png"
            ...
            draw = TfPoseEstimator.draw_humans(draw, humans, imgcopy=False)
